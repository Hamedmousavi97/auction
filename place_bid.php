<?php
    ...
    // This page is used to handle the bid placement process
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // get the auction details from the database with the auction ID
        ...
        if ($auctionCreator == $username) {
            ...
            // Inform the user that they cannot bid on their own auction
            echo '<script>
            ...
            if ($bidAmount > $current_price ) {
                ...
                // Update the current highest bid on the auction table
                ...
                if ($stmt->execute()) {
                    ...
                    if ($stmt2->execute()) {
                        ...
                        // Send email to the auction creator and the bid placer
                        ...
                        if ($stmt3->execute()) {
                            ...
                            // inform the user that their bid has been placed successfully
                            ...
                            // Inform the user that their bid has not been placed successfully
